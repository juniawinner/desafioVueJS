...
<template>
  <div>
      ...
      <Dialog as="div" class="relative z-40 md:hidden" @close="sidebarOpen = false">
        ...
        <div class="fixed inset-0 flex z-40">
          <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
            ...
            <DialogPanel class="relative flex-1 flex flex-col max-w-xs w-full bg-slate-300">
    ...
    <div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
      ...
      <div class="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-slate-300">
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          ...
          <nav class="mt-5 flex-1 px-2 bg-slate-300 space-y-1">
            <span v-for="item in navigation" :key="item.name">
    ...
    <div class="md:pl-64 flex flex-col flex-1">
      <div class="sticky top-0 z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-slate-300">
        <button type="button"
